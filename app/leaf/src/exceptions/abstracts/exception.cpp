...
Leaf::Exceptions::Abstracts::Exception::Exception(const std::source_location &sourceLocation) : _sourceLocation(
        sourceLocation) {
    *this << boost::errinfo_api_function(_sourceLocation.function_name())
          << boost::errinfo_at_line(static_cast<int>(_sourceLocation.line()));
}
