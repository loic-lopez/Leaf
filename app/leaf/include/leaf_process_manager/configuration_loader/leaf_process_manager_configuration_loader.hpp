...
{
  public:
    inline static constinit const PropertyString LEAF_SERVERS_SECTION       = "LeafServers"sv;
    inline static constinit const PropertyString LEAF_CONFIGURATION_SECTION = "LeafConfiguration"sv;
    inline static constinit const PropertyString HTTP_CONFIGURATION_SECTION = "HttpConfiguration"sv;
  ...
  private:
    inline static const PropertiesContainer _leaf_servers_section_properties = {
      {"servers_root_path"sv},
    };

    inline static const PropertiesContainer _leaf_configuration_section_properties = {
      {"leaf_log_directory"sv},
    };

    inline static const PropertiesContainer _http_configuration_section_properties = {
